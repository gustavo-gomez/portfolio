      ...
      <section id='home' className="bg-bg-principal-light dark:bg-bg-dark flex h-screen">
        <div className="flex flex-col lg:flex-row w-full justify-center items-center gap-6 ">
          ...
          <div className='flex justify-center flex-col max-w-xl mx-4 md:mx-0 '>
            <p className={`${barlowCondensed.className} text-xl md:text-3xl font-bold text-txt-secondary dark:text-white`}>Hey, soy Gustavo</p>
            <p className={`${barlowCondensed.className} text-3xl md:text-5xl font-bold text-primary-light dark:text-primary-dark `}>Software Engineer</p>
            <p className='text-lg md:text-xl my-5'>
              ...
              <strong className='text-primary-light dark:text-primary-dark font-bold opacity-90'>{" web y mobile"}</strong>
            </p>
            <Icons/>
          </div>
        </div>
